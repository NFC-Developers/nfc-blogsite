...
export default function Home() {
  ...
  return (
    <div className="font-sans min-h-screen flex flex-col">
      ...
      {/* Page content */}
      <main className="flex-1 p-8 sm:px-20 sm:py-8 flex flex-col gap-8">
        {/*
        ...
        */}
        <Announcement stories={getTopStories()}/>
        <div className="flex gap-4">
          <StoryList large={false} title="New Stories" stories={getNewStories()} />
          <StoryList large={false} title="Latest Updates" stories={getLatestUpdates()} />
        </div>
      </main>
    </div>
  );
